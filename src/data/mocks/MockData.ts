...
export const RespiesMockData: IRecipe[] = [
    mockRecipe({
        "id": 716429,
        "title": "Pasta with Garlic, Scallions, Cauliflower & Breadcrumbs",
    ...
    mockRecipe({
        ...
        "image": "https://spoonacular.com/recipeImages/715539-312x231.jpg",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715540,
    ...
    mockRecipe({
        ...
        "image": "https://spoonacular.com/recipeImages/715542-312x231.jpg",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715543,
    ...
    mockRecipe({
        ...
        "image": "https://spoonacular.com/recipeImages/715546-312x231.jpg",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715547,
    ...
    mockRecipe({
        ...
        "image": "https://images.unsplash.com/photo-1518461178099-05b2e674dc33",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715579,
        "title": "Veggie Burger",
        "image": "https://images.unsplash.com/photo-1496568554266-bc8a06b4d8b5",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715580,
        "title": "Grilled Cheese Sandwich",
        "image": "https://images.unsplash.com/photo-1518510227856-30619d542ea9",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715581,
    ...
    mockRecipe({
        ...
        "image": "https://images.unsplash.com/photo-1518461178099-05b6d646d496",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715587,
    ...
    mockRecipe({
        ...
        "image": "https://images.unsplash.com/photo-1534352436920-f658b50b73fe",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715590,
    ...
    mockRecipe({
        "id": 715591,
        "title": "Baked Ziti",
        "image": "https://images.unsplash.com/photo-1484344958632-f7264ab1c85c",
        "imageType": "jpg",
    }),
    mockRecipe({
        "id": 715593,
        "title": "BBQ Chicken Pizza",
        "image": "https://images.unsplash.com/photo-1511896936-104afaf25887",
        "imageType": "jpg",
    }),
